...
var DatePickerCustom = function DatePickerCustom(_ref2) {
  var name = _ref2.name,
      ...
      restProps = (0, _objectWithoutProperties2.default)(_ref2, ["name", "min", "max", "dayPlaceholder", "monthPlaceholder", "yearPlaceholder", "popupDirection", "defaultValue", "hasMouse", "monthNames", "day", "month", "year", "onDateChange", "disabled"]);
...
var DatePickerNative = function DatePickerNative(_ref3) {
  var min = _ref3.min,
      ...
      restProps = (0, _objectWithoutProperties2.default)(_ref3, ["min", "max", "dayPlaceholder", "monthPlaceholder", "yearPlaceholder", "popupDirection", "defaultValue", "hasMouse", "day", "month", "year", "onDateChange"]);
  ...
  var onStringChange = (0, _react.useCallback)(function (e) {
...
var DatePicker = function DatePicker(_ref4) {
  var hasMouse = _ref4.hasMouse,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref4, ["hasMouse", "defaultValue"]);
  ...
  var onDateChange = (0, _react.useCallback)(function (update) {
    setValue(update);
