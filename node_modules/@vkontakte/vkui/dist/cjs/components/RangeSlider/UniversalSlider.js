...
var UniversalSliderDumb = function UniversalSliderDumb(_ref) {
  var min = _ref.min,
      ...
      restProps = (0, _objectWithoutProperties2.default)(_ref, ["min", "max", "step", "value", "defaultValue", "onChange", "getRootRef", "sizeY", "disabled"]);
  ...
  var gesture = (0, _react.useRef)({
    dragging: false,
    startX: 0,
    containerWidth: 0
  }).current;
  var container = (0, _useExternRef.useExternRef)(getRootRef);
  var thumbStart = (0, _react.useRef)();
  var thumbEnd = (0, _react.useRef)();
